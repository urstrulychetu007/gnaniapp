...
public class SpeechService extends Service {
    ...
    private void fetchAccessToken(String uidvalue,String tokenValue, String langValue, String akeyValue, String audioFormatValue, String encodingValue, String sadValue, String ipValue, int portValue, boolean tls) {
        try {
            ...
            Metadata.Key<String> token = Metadata.Key.of(getString(com.gnani.ai.R.string.token_key), Metadata.ASCII_STRING_MARSHALLER);
            header.put(token, tokenValue);
            Metadata.Key<String> lang = Metadata.Key.of(getString(com.gnani.ai.R.string.lang_key), Metadata.ASCII_STRING_MARSHALLER);
            header.put(lang, langValue);
            Metadata.Key<String> akey = Metadata.Key.of(getString(com.gnani.ai.R.string.access_key_key), Metadata.ASCII_STRING_MARSHALLER);
            header.put(akey, akeyValue);
            Metadata.Key<String> audioformat = Metadata.Key.of(getString(com.gnani.ai.R.string.audio_format_key), Metadata.ASCII_STRING_MARSHALLER);
            header.put(audioformat, audioFormatValue);
            Metadata.Key<String> encoding = Metadata.Key.of(getString(com.gnani.ai.R.string.encoding_key), Metadata.ASCII_STRING_MARSHALLER);
            header.put(encoding, encodingValue);
            Metadata.Key<String> sad = Metadata.Key.of(getString(com.gnani.ai.R.string.silence_key), Metadata.ASCII_STRING_MARSHALLER);
            header.put(sad, sadValue);
            try {

                if (uidvalue == null || uidvalue.equals("")) {

                    String answer = com.gnani.ai.Recorder.getDefaults("user", getApplicationContext());
                    if (answer == null) {
